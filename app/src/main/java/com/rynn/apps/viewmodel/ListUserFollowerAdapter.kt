...
import com.rynn.apps.model.UserFollower
import kotlinx.android.synthetic.main.user_item.view.*

class ListUserFollowerAdapter(private val listUserFollower: ArrayList<UserFollower>) :
    RecyclerView.Adapter<ListUserFollowerAdapter.ListUserHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ListUserFollowerAdapter.ListUserHolder {
    ...
    inner class ListUserHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(userFollower: UserFollower) {
            with(itemView) {
                ...
                user_repo.text =
                    StringBuilder(resources.getString(R.string.user_repo)).append(": ${userFollower.repository}")
                user_followers.text =
                    StringBuilder(resources.getString(R.string.follower)).append(": ${userFollower.followers}")
                user_following.text =
                    StringBuilder(resources.getString(R.string.following)).append(": ${userFollower.following}")
            }
        }
    }
}
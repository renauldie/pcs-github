...
import com.rynn.apps.view.DetailActivity
    ...
    inner class ListUserHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(userItem: UserItem) {
            with(itemView) {
                ...
                user_repo.text =
                    StringBuilder(resources.getString(R.string.user_repo)).append(": ${userItem.repository}")
                user_followers.text =
                    StringBuilder(resources.getString(R.string.follower)).append(": ${userItem.followers}")
                user_following.text =
                    StringBuilder(resources.getString(R.string.following)).append(": ${userItem.following}")
            }
        }
    }
}